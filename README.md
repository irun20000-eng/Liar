...
- **장소 풀**: 공연·체험·박물관·명소·맛집·숙소·근교 원정(강화·인천·파주·과천) 70곳 — 운영시간·요금·예약·주차·비고·지도 링크, 초성 검색과 필터
- **추천 일정 5개 안**: 정석 / 실내 집중 / 강화도 원정 / 인천 원정 / 역사·과학 심화 — 일자별 타임테이블(이동·비고 포함)
- **내 일정 만들기**: 풀에서 담아 순서 조정 → 이동시간·종료시각·5인 예산 자동 계산, 휴무·운영시간 충돌 경고, JSON 내보내기/가져오기, 인쇄
- **가족 찜 투표**, **예매 D-day 체크리스트**, **Leaflet 지도 동선**
